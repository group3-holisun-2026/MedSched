...
function Navbar() {
    ...
    // Ascunde complet Navbar-ul pentru rutele publice (ex: link-ul din notificare).
    // Iesirea din componenta se face dupa toate hook-urile, altfel ordinea lor difera
    // intre /c/:token si restul rutelor si React arunca "rendered fewer hooks than expected".
