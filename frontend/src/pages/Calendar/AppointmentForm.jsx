...
// minute. Folosim <select> in loc de <input type="time" min max> pentru ca browserele nu filtreaza
// selectorul nativ de ora dupa min/max - doar valideaza la submit, deci userul tot putea "derula"
// prin toate cele 24h. Cu select-ul, pur si simplu nu exista in lista nicio ora din afara programului.
...
const AppointmentForm = ({ initialData, onSave, onCancel }) => {
    ...
    // Data si ora sunt tinute intern tot ca un singur string "YYYY-MM-DDTHH:mm" (formData.startTime),
    // dar afisate ca doua inputuri separate (vezi TIME_SLOT_OPTIONS mai sus pentru selectorul de ora).
    ...
    const handleSubmit = async (e) => {
        ...
        // Plasa de siguranta pe langa min/max nativ de pe inputul de ora - nu toate browserele
        // blocheaza strict la submit o ora tastata manual in afara intervalului.
